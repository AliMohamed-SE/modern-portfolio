          ...
          .map(({ id, title, des, img, iconLists, link }) => (
            ...
            >
              <PinContainer title={link} href={link}>
                <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden h-[30vh] mb-10 sm:h-[40vh] p-10">
                  <div className="absolute w-full h-full overflow-hidden lg:rounded-3xl bg-[#13162d]">
                    <img src="/bg.png" alt="bg-img" />
                  </div>
                  <div className="z-10 absolute -bottom-2 w-[80%] h-[80%] rotate-3 rounded-2xl overflow-hidden border">
                    <img
                      src={img}
                      alt={title}
