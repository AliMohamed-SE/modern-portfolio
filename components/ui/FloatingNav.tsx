    ...
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          ...
          "flex max-w-fit md:min-w-[70vw] lg:min-w-fit fixed z-[5000] sm:top-10 top-5 md:inset-x-0 inset-x-4 mx-auto px-10 py-3 rounded-full border border-black/.1 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] items-center justify-center space-x-4",
          className
        )}
        style={{
